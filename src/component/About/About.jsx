...
const About = () => {
    return (
        <div id='about' className='shadow-xl bg-[#162037] my-10'>

            <div className='text-slate-400 md:grid grid-cols-4 w-full '>
                ...
                <div className='col-span-3 p-5 space-y-2'>
                    ...
                    <p className='font-semibold'><span  className='text-green-500'> Experience: </span> Last 3 years I have successfully completed many outsourcing projects and build a professional relationship with foreign client.I worked in the freelancer marketplace as a virtual assistant.At present I am seeking for a job role as a junior Mern stack developer.As a mern stack developer I am sharing principle that I have experienced</p>

                    <p className='font-semibold'>
                       <span className='text-green-700'> MongoDB:</span> I have knowledge of NoSQL databases and can work with MongoDB, I can create, query, and manage databases and collections. <br />

                       <span className='text-green-700'> Express.js</span> I am comfortable working with Express.js, I can create RESTful APIs, handle routing, and implement middleware for request handling. <br />

                       <span className='text-green-700'> React.js:</span>  I have a good understanding of React.js I can create reusable components, manage state and props, and implement event handling. I have experience working with React Router for handling navigation and routing in single-page applications. <br />

                       <span className='text-green-700'> Node.js:</span> I am proficient in server-side JavaScript using Node.js. I can build scalable and efficient web applications, handle HTTP requests, implement authentication and authorization, and work with databases.
